    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                //  location.href = "http://localhost:8080/books/cartServlet?action=addItems&id=" + id;
                $.getJSON("http://localhost:8080/books/cartServlet", "action=ajaxAddItems&id=" + id, function (data) {
